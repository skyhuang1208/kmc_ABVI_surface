...
const double par_muvA=			   5.0e+15; // units: s^-1 
const double par_muvB=			   5.0e+15; // units: s^-1 
const double par_muiA=			   5.0e+15; // units: s^-1 
const double par_muiB=			   5.0e+15; // units: s^-1 
